...
import '../../../res.dart';
import 'MadaWebView.dart';
import 'VisaWebView.dart';
      ...
      body: loading
          ...
          : ListView(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      //       Text(cartDetailsModel.data.street.toString(),style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
                      //     ],
                      //   ),
                      // ),
                      // Row(
                      ...
                      //     Text(cartDetailsModel.data.residence.toString(),style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
                      //   ],
                      // ),
                      // Padding(
                      //   padding: const EdgeInsets.symmetric(vertical: 8),
                      ...
                      //       Text(cartDetailsModel.data.floor.toString(),style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
                      //     ],
                      //   ),
                      // ),
                      Row(
                ...
                Container(
                  height: 155.0 * cartDetailsModel.data.services.length,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            height: 16.0 * cartDetailsModel.data.services[index].services.length,
            child: ListView.builder(
                itemCount:
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData["key"] == "success") {
          ...
          minTotal = double.parse(cartDetailsModel.data.miniOrderCharge.toString());
  ...
  Future addCoupon() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData["key"] == "success") {
          setState(() {
            couponVal = responseData["data"]["value"];
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(tr("alertMsgMin1"),style: GoogleFonts.almarai(fontSize: 16)),
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 5),
                            child: Text(minTotal.toString(),style: GoogleFonts.almarai(fontSize: 16,fontWeight: FontWeight.bold)),
                          ),
                          Text(tr("rs"),style: GoogleFonts.almarai(fontSize: 13)),
                        ],
                      ),

                      Padding(
                        padding: const EdgeInsets.only(top: 10),
                        child: Text(tr("alertMsgMin2"),style: GoogleFonts.almarai(fontSize: 15)),
                      ),
